...
class VagaController extends Zend_Controller_Action {
    ...
    public function preDispatch() {
        ...
        $this->form = new Application_Form_FormVaga();
        $this->mapper = new Application_Model_VagaMapper();
        $this->model = new Application_Model_Vaga();
        $this->view->pagina = 'vaga';
    }
    ...
    public function listarAction() {
        $this->view->titulo = 'Listagem de Vagas';
        //Paginação 
        $request = $this->getRequest();
    ...
    public function atualizarAction() {
        ...
        if ($request->isGet()) {
            ...
            if (!$this->form->isValid($request->getPost())) {
                ...
                $modelNovo = new Application_Model_Vaga($this->form->getValues());
